...
export default class GoogleProvider extends BaseProvider {
  ...
  staticModels: ModelInfo[] = [
    { name: 'gemini-2.5-pro-preview-05-06', label: 'Gemini 2.5 Pro', provider: 'Google', maxTokenAllowed: 65536 },
    { name: 'gemini-2.5-flash-preview-04-17', label: 'Gemini 2.5 Flash', provider: 'Google', maxTokenAllowed: 65536 },
