...
function CurrentDateTime() {
  ...
  return (
    <div className="flex items-center gap-2 px-4 py-2 text-sm text-bolt-elements-textSecondary border-b border-[rgba(255,215,0,0.08)]">
    ...
    <>
      <motion.div
        ...
        className={classNames(
          ...
          'bg-bolt-elements-background-depth-1 border-r border-[rgba(255,215,0,0.08)]',
          'shadow-sm text-sm',
          isSettingsOpen ? 'z-40' : 'z-sidebar',
        )}
      >
        <div className="h-12 flex items-center justify-between px-4 border-b border-[rgba(255,215,0,0.08)] bg-[rgba(255,215,0,0.02)]">
        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          <div className="p-4 space-y-3">
            <div className="flex gap-2">
              <a
                href="/"
                className="flex-1 flex gap-2 items-center bg-[rgba(255,215,0,0.08)] text-[#FFD700] hover:bg-[rgba(255,215,0,0.15)] rounded-lg px-4 py-2 transition-all duration-300 hover:shadow-[0_0_12px_rgba(255,215,0,0.15)]"
              >
              ...
              <button
                ...
                className={classNames(
                  ...
                  selectionMode
                    ? 'bg-[rgba(255,215,0,0.2)] text-[#FFD700] border border-[rgba(255,215,0,0.4)]'
            ...
            <div className="relative w-full">
              ...
              <input
                className="w-full bg-bolt-elements-background-depth-2 relative pl-9 pr-3 py-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-[rgba(255,215,0,0.3)] text-sm text-bolt-elements-textPrimary placeholder-bolt-elements-textTertiary border border-bolt-elements-borderColor"
                type="search"
          ...
          <div className="flex items-center justify-between border-t border-[rgba(255,215,0,0.08)] px-4 py-3">
